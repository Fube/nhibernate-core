...
namespace NHibernate.Test.UtilityTest
{
	...
	/// <see cref="IdentityMap{TKey,TValue}.InstantiateSequenced"/> makes.
	/// </summary>
	[TestFixture]
	public class IdentityMapGenericSequencedFixture : IdentityMapGenericFixture
	{
		protected override IDictionary<object, object> GetIdentityMap()
		{
			return IdentityMapUtils.InstantiateSequenced<object, object>(10);
		}
		...
		public void SnapshotPreservesOrder()
		{
			...
			using var snapshot = IdentityMap<object, object>.GetEntries(map);
