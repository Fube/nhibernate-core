...
namespace NHibernate.Test.UtilityTest
{
	...
	/// <see cref="IdentityMapFixture"/>. Uses <see cref="MutableHashCode"/> and
	/// <see cref="NoHashCode"/> to verify that identity (reference) semantics are used for
	/// key comparisons rather than the key type's own <c>Equals</c>/<c>GetHashCode</c>.
	/// </summary>
	[TestFixture]
	public class IdentityMapGenericFixture
	{
		...
		public void GetEntries()
		{
			...
			var snapshot = IdentityMap<object, object>.GetEntries(map);
